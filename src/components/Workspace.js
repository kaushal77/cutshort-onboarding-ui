...
function Workspace() {
  return (
    <div>
        ...
        <input type="text" id= "workspacename" style={{width:'100%',padding:'5px 4px',borderColor:'lightgrey !important',color:'gray',marginBottom:'10px'}} />
        <br/>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" required id="basic-url" aria-describedby="basic-addon3" style={{padding:'5px 4px',borderColor:'lightgrey !important', color:'gray'}} placeholder="Example" />
        </div>
